...
export default function RefactoredOngoing() {
  ...
  const handleNavigate = (id, project) => {
    router.push({
      pathname: `/details/${id}`,
      query: { name: project.name, category: project.category }, // If you want to pass extra data
    })
  }
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto h-full flex flex-col justify-center items-start px-6">
          ...
          >
            Modern ve sürdürülebilir çözümlerle hayata geçirilen projelerimizi keşfedin.
          </motion.p>
        </div>
      </div>
            ...
            : filteredProjects.map((project, index) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-sm font-light text-gray-600 mt-2">{project.category}</p>
                  </div>
                </motion.div>
              ))}
        </div>
